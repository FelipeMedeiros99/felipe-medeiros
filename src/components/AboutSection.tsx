...
const texts = [
  ...
  `Atualmente sou acadêmico no curso de sistema da informação (4° período).`,

  `Uma das minhas principais características é a capacidade de identificar problemas e criar ferramentas práticas e eficientes para automatizar e facilitar tarefas repetitivas, o que resulta em ganhos de produtividade e redução de erros.`,
